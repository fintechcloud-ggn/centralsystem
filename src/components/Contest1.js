  ...
  const leaderboard = [
    {
      ...
      entries: previewData?.firstEntries || 0,
      streak: previewData?.firstStreak || "-"
    },
    {
      position: 2,
      name: previewData?.second_place || "Winner 2",
      points: previewData?.second_points || 0,
      entries: previewData?.secondEntries || 0,
      streak: previewData?.secondStreak || "-"
    },
    {
      position: 3,
      name: previewData?.third_place || "Winner 3",
      points: previewData?.third_points || 0,
      entries: previewData?.thirdEntries || 0,
      streak: previewData?.thirdStreak || "-"
    },
  ];
          ...
          <section className="w-full md:w-1/2 rounded-2xl border border-[#d6d2e3] bg-[#f8f6fc]/95 p-4 md:p-6 flex flex-col">
            ...
            <div className="mt-auto pt-4">
              <div className="rounded-xl bg-[#2f1048] text-white px-4 py-3 flex items-center justify-between">
                ...
                <span className="text-[#f2bb2f] font-bold text-sm md:text-base">
                  08:00 PM
                </span>
              </div>
            </div>
